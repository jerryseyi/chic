  ...
  <!-- component -->
    <div class="py-6">
        <div class="w-full flex items-end justify-end">
            <router-link :to="{name: 'edit-product', params: {id}}"
                         class="bg-purple-700 px-2 py-3 rounded-md text-white text-xs mr-5">Edit
            </router-link>
        ...
        <div class="flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden">
            ...
            <div class="w-2/3 p-4">
                ...
                <div class="flex item-center justify-between mt-3">
                    ...
                    <button class="px-3 py-2 bg-gray-800 text-white text-xs font-bold uppercase rounded">Add to Card
                    </button>
                </div>
            </div>
        </div>
